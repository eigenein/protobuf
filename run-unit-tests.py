...
class TestBytes(unittest.TestCase):
    ...
    def test_dumps_1(self):
        self.assertEqual(Bytes.dumps(b'testing'), b'\x07\x74\x65\x73\x74\x69\x6e\x67')

    def test_loads_1(self):
        self.assertEqual(Bytes.loads(b'\x07\x74\x65\x73\x74\x69\x6e\x67'), b'testing')

class TestUnicode(unittest.TestCase):

    def test_dumps_1(self):
        self.assertEqual(Unicode.dumps(u'Привет'), b'\x0c\xd0\x9f\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb5\xd1\x82')

    def test_loads_1(self):
        self.assertEqual(Unicode.loads(b'\x0c\xd0\x9f\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb5\xd1\x82'), u'Привет')
...
class TestMessageType(unittest.TestCase):
    ...
    def test_dump_1(self):
        ...
        fp = io.BytesIO()
        msg.dump(fp)
        self.assertEqual(fp.getvalue(), b'\x12\x07\x74\x65\x73\x74\x69\x6e\x67')
